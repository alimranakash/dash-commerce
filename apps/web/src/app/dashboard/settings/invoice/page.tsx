  ...
  return (
    <DashboardShell storeSlug={store.slug}>
      <section className="resource-page max-w-none">
        ...
        <InvoiceSettingsForm action={updateInvoiceSettingsFormAction} settings={moduleSettings.invoice} storeName={store.name} storeUrl={`https://${storeSubdomain(store.slug)}`} />
      </section>
    </DashboardShell>
  );
}
