...
export function OnboardingForm() {
  ...
  const previewDomain = useMemo(() => `${draft.storeSlug || "yourstore"}.dash.com`, [draft.storeSlug]);
      ...
      <section className={styles.formCard}>
        ...
        <form className={styles.stepForm} onSubmit={handleSubmit}>
          <div className={styles.stepBody}>
            ...
            {step === 2 ? <StoreUrlStep domain={previewDomain} value={draft.storeSlug} onChange={(value) => { setSlugEdited(true); setDraft((current) => ({ ...current, storeSlug: slugify(value) })); setError(null); }} /> : null}
